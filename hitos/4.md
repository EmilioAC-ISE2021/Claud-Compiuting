...
He [configurado](/.github/workflows/build.yml) github actions para que cada vez que se haga un push se vuelva a generar el contenedor y a pasar los tests. No sé qué más comentar sobre esto.
